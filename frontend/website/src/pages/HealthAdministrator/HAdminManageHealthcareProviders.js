  ...
  const fetchHCPs = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setError(
          'Error fetching healthcare providers. Please try again later.'
        );
      }
    } catch (error) {
  ...
  const handleToggleStatus = async (ID) => {
    try {
      ...
      if (response.ok) {
        ...
        setError(
          'Error toggling healthcare provider account status. Please try again later.'
        );
      }
    } catch (error) {
  ...
  const handleUpdate = async (updatedHCP) => {
    try {
      ...
      if (response.ok) {
        ...
        setError(
          'Error updating healthcare provider details. Please try again later.'
        );
      }
    } catch (error) {
      console.error('Error:', error);
