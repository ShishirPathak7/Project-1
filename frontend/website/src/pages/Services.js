      ...
      <div style={cardStyle}>
        ...
        {loading ? (
          ...
          <>
            ...
            <p>
              Our hospital offers a wide range of medical services to ensure
              comprehensive care for all patients.
            </p>

            <h2>Advanced Treatments</h2>
            <p>
              We utilize cutting-edge technology and treatments to provide the
              best possible outcomes for our patients.
            </p>

            <h2>Accessibility for All</h2>
            <p>
              Ensuring healthcare is accessible to everyone, our facilities are
              equipped to accommodate patients of all needs.
            </p>

            <h2>Mental Health Support</h2>
            <p>
              Our dedicated mental health professionals offer compassionate care
              and comprehensive treatment options.
            </p>

            <h2>Wellness and Prevention</h2>
            <p>
              Focusing on prevention and wellness, we offer programs and
              resources to help patients maintain a healthy lifestyle.
            </p>

            <h2>Research and Innovation</h2>
            <p>
              At the forefront of medical research, we are committed to
              innovation and improving healthcare outcomes.
            </p>
          </>
        )}
      </div>
