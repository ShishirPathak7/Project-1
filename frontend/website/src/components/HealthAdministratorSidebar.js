        ...
        >
          <ul className="nav">
            ...
            <li className="nav-item">
              <CustomLink to="/FacilitiesPage" className="nav-link">
                Facilities Management
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink to="/HAdminDataOversight" className="nav-link">
                Data Oversight
              </CustomLink>
            </li>
            <li className="nav-item">
              <CustomLink
                to="/HAdminManageHealthcareProviders"
                className="nav-link"
              >
            ...
            <li className="nav-item">
              <CustomLink
                to="/HAdminManagePharmacistAdmin"
                className="nav-link"
              >
                Manage Pharmacists
              </CustomLink>
